...
abstract class BaseSysUsersPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdUser', 'Username', 'Password', 'Email', 'FirstName', 'LastName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idUser', 'username', 'password', 'email', 'firstName', 'lastName', ),
        BasePeer::TYPE_COLNAME => array (SysUsersPeer::ID_USER, SysUsersPeer::USERNAME, SysUsersPeer::PASSWORD, SysUsersPeer::EMAIL, SysUsersPeer::FIRST_NAME, SysUsersPeer::LAST_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_USER', 'USERNAME', 'PASSWORD', 'EMAIL', 'FIRST_NAME', 'LAST_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id_user', 'username', 'password', 'email', 'first_name', 'last_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdUser' => 0, 'Username' => 1, 'Password' => 2, 'Email' => 3, 'FirstName' => 4, 'LastName' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idUser' => 0, 'username' => 1, 'password' => 2, 'email' => 3, 'firstName' => 4, 'lastName' => 5, ),
        BasePeer::TYPE_COLNAME => array (SysUsersPeer::ID_USER => 0, SysUsersPeer::USERNAME => 1, SysUsersPeer::PASSWORD => 2, SysUsersPeer::EMAIL => 3, SysUsersPeer::FIRST_NAME => 4, SysUsersPeer::LAST_NAME => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_USER' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'EMAIL' => 3, 'FIRST_NAME' => 4, 'LAST_NAME' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id_user' => 0, 'username' => 1, 'password' => 2, 'email' => 3, 'first_name' => 4, 'last_name' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
