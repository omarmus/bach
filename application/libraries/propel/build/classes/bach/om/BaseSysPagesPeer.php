...
abstract class BaseSysPagesPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdPage', 'Title', 'Slug', 'Order', 'Body', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idPage', 'title', 'slug', 'order', 'body', ),
        BasePeer::TYPE_COLNAME => array (SysPagesPeer::ID_PAGE, SysPagesPeer::TITLE, SysPagesPeer::SLUG, SysPagesPeer::ORDER, SysPagesPeer::BODY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_PAGE', 'TITLE', 'SLUG', 'ORDER', 'BODY', ),
        BasePeer::TYPE_FIELDNAME => array ('id_page', 'title', 'slug', 'order', 'body', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdPage' => 0, 'Title' => 1, 'Slug' => 2, 'Order' => 3, 'Body' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idPage' => 0, 'title' => 1, 'slug' => 2, 'order' => 3, 'body' => 4, ),
        BasePeer::TYPE_COLNAME => array (SysPagesPeer::ID_PAGE => 0, SysPagesPeer::TITLE => 1, SysPagesPeer::SLUG => 2, SysPagesPeer::ORDER => 3, SysPagesPeer::BODY => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_PAGE' => 0, 'TITLE' => 1, 'SLUG' => 2, 'ORDER' => 3, 'BODY' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id_page' => 0, 'title' => 1, 'slug' => 2, 'order' => 3, 'body' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SysPagesPeer::BODY);
        } else {
