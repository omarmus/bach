...
/**
 * Base class that represents a row from the 'sys_chats' table.
 *
 * 
 *
 * @package    propel.generator.bach.om
 */
abstract class BaseSysChats extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'SysChatsPeer';
    ...
    /**
     * The value for the id_chat field.
     * @var        int
     */
    protected $id_chat;
    ...
    public function setIdChat($v)
    {
        ...
        if ($this->id_chat !== $v) {
            $this->id_chat = $v;
            $this->modifiedColumns[] = SysChatsPeer::ID_CHAT;
        }
    ...
    public function setIdSender($v)
    {
        ...
        if ($this->id_sender !== $v) {
            $this->id_sender = $v;
            $this->modifiedColumns[] = SysChatsPeer::ID_SENDER;
        }
    ...
    public function setIdReceiver($v)
    {
        ...
        if ($this->id_receiver !== $v) {
            $this->id_receiver = $v;
            $this->modifiedColumns[] = SysChatsPeer::ID_RECEIVER;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[] = SysChatsPeer::MESSAGE;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = SysChatsPeer::CREATED;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->id_chat = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 5; // 5 = SysChatsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating SysChats object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = SysChatsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = SysChatsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SysChatsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = SysChatsPeer::ID_CHAT;
        if (null !== $this->id_chat) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . SysChatsPeer::ID_CHAT . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(SysChatsPeer::ID_CHAT)) {
            $modifiedColumns[':p' . $index++]  = '`id_chat`';
        }
        if ($this->isColumnModified(SysChatsPeer::ID_SENDER)) {
            $modifiedColumns[':p' . $index++]  = '`id_sender`';
        }
        if ($this->isColumnModified(SysChatsPeer::ID_RECEIVER)) {
            $modifiedColumns[':p' . $index++]  = '`id_receiver`';
        }
        if ($this->isColumnModified(SysChatsPeer::MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = '`message`';
        }
        if ($this->isColumnModified(SysChatsPeer::CREATED)) {
            $modifiedColumns[':p' . $index++]  = '`created`';
        }

        $sql = sprintf(
            'INSERT INTO `sys_chats` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_chat`':						
                        $stmt->bindValue($identifier, $this->id_chat, PDO::PARAM_INT);
                        break;
                    case '`id_sender`':						
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = SysChatsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = SysChatsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SysChats'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SysChats'][$this->getPrimaryKey()] = true;
        $keys = SysChatsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdChat(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdChat($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SysChatsPeer::ID_CHAT)) $criteria->add(SysChatsPeer::ID_CHAT, $this->id_chat);
        if ($this->isColumnModified(SysChatsPeer::ID_SENDER)) $criteria->add(SysChatsPeer::ID_SENDER, $this->id_sender);
        if ($this->isColumnModified(SysChatsPeer::ID_RECEIVER)) $criteria->add(SysChatsPeer::ID_RECEIVER, $this->id_receiver);
        if ($this->isColumnModified(SysChatsPeer::MESSAGE)) $criteria->add(SysChatsPeer::MESSAGE, $this->message);
        if ($this->isColumnModified(SysChatsPeer::CREATED)) $criteria->add(SysChatsPeer::CREATED, $this->created);
    ...
    {
        $criteria = new Criteria(SysChatsPeer::DATABASE_NAME);
        $criteria->add(SysChatsPeer::ID_CHAT, $this->id_chat);
    ...
    /**
     * Generic method to set the primary key (id_chat column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of SysChats (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdChat(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return SysChats Clone of current object.
     * @throws PropelException
     */
    ...
    public function setSysUsersRelatedByIdSender(SysUsers $v = null)
    {
        ...
        // If this object has already been added to the SysUsers object, it will not be re-added.
        if ($v !== null) {
            $v->addSysChatsRelatedByIdSender($this);
        }
    ...
    public function getSysUsersRelatedByIdSender(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSysUsersRelatedByIdSender === null && ($this->id_sender !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSysUsersRelatedByIdSender->addSysChatssRelatedByIdSender($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(SysChatsPeer::DEFAULT_STRING_FORMAT);
    }
